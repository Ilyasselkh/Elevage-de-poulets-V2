      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-red-500 to-rose-500 bg-clip-text text-transparent">
              La Plume Blanche
            </h3>
            <p className="text-gray-400 leading-relaxed mb-6 max-w-md">
              Spécialiste de l&apos;élevage de volailles au Maroc, nous nous engageons à fournir des produits de qualité supérieure dans le respect du bien-être animal.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} La Plume Blanche. Tous droits réservés.
            </p>
