        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="group relative w-11 h-11 bg-gray-800 rounded-xl flex items-center justify-center overflow-hidden transition-all duration-300 hover:bg-red-600 hover:scale-110"
                aria-label="Facebook"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-red-500 to-rose-600 opacity-0 group-hover:opacity-100 transition-opacity"></div>
